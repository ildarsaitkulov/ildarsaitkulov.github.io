...
В этой статье мы разобрались с основами работы docker, docker compose узнали о контейнеризации и контейнере, научились скачивать готовые образы и создавать свои, развернули простое веб-приложение с использованием php-fpm + nginx + postgres.
